...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707110080
...
cp %{_builddir}/ansible-pygments-%{version}/LICENSE.md %{buildroot}/usr/share/package-licenses/pypi-ansible_pygments/02f46c5154752a0af7d98adae5c78107edf64727 || :
